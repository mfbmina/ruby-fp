...
This is a repo for keeping my studies in FP using Ruby.

----
## Contents
 
- [Pure functions](https://github.com/mfbmina/ruby-fp/blob/master/pure_functions.rb)
- [Immutability](https://github.com/mfbmina/ruby-fp/blob/master/immutability.rb)
